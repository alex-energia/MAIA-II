...
def home():
    ...
    <style>
        ...
        .telemetry {{ position:absolute; bottom:15px; left:15px; color:#0f0; font-size:9px; pointer-events:none; }}
    </style>
    </head><body>
    ...
    <div class='grid-master'>
        ...
        <div class="panel" style="padding:0; overflow:hidden;">
            <div id="proto-container">
                <div class="telemetry">SISTEMA: ONLINE | ALT: 12.4m | MOTORES: SYNC</div>
            </div>
        </div>
        ...
        <div class="panel" id="panel-derecho">
            ...
            <div style="color:#f0f; font-size:10px; margin-top:10px;">EDITOR DE KERNEL:</div>
    ...
    <script>
        ...
        if (container) {{
            ...
            const body = new THREE.Mesh(new THREE.CylinderGeometry(0.8, 1, 0.5, 6), new THREE.MeshPhongMaterial({{color: 0x111111, specular: 0x00ffff, shininess: 100}}));
            droneGroup.add(body);
